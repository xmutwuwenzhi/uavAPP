...
extern char gps_time[20], lati[20], longti[20], angle[20];
float32_t ARDrone_phi;
float32_t ARDrone_theta;
...
{
	navdata_demo_t navdata_demo=navdata->navdata_demo;
	ARDrone_phi = navdata_demo.phi;
	ARDrone_theta=navdata_demo.theta;
